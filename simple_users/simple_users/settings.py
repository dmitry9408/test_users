"""
Django settings for simple_users project.
...
SECRET_KEY = environ.get('SECRET_KEY')  # 'django-insecure-z8rra^uapcp-flbf16&0+f-t$!c6^@dc5ir-f5kzk-g
# %yomjjr'
...
ROOT_URLCONF = 'simple_users.urls'
...
WSGI_APPLICATION = 'simple_users.wsgi.application'
